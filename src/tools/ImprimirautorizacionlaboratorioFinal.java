...
public class ImprimirautorizacionlaboratorioFinal {
    private String idevu, codigo, version, nombrereport, servicio;
    private Connection conexion;
    public File tempFile;
    
    public PdfReader ImprimirautolabFinal(){
        try {
            ...
            JasperPrint informe = JasperFillManager.fillReport(System.getProperty("user.dir")+"/reportes/solicitudprocedimientolabpost.jasper", parametro, getConnection());

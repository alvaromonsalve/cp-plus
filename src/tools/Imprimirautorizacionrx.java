...
public class Imprimirautorizacionrx {
    ...
    public PdfReader Imprimirautorx(){
        try {
            ...
            JasperPrint informe = JasperFillManager.fillReport(System.getProperty("user.dir")+"/Reportes/solicitudprocedimientoimage.jasper", parametro, getConnection());
...
//            tempFile.deleteOnExit();
            ...
            JOptionPane.showMessageDialog(null,"!Error General Lanzando Reporte Descripcion: Ex00026 \n" +e.getMessage());
            return null;
        } catch (JRException e) {
            JOptionPane.showMessageDialog(null,"!Error General Lanzando Reporte Descripcion: Ex00026 \n" +e.getMessage());
            return null;

 ...
 private String idevolucion, Nombrereport, CodigoReport, Servicioreport, Versionreport;
     ...
     public PdfReader ImprimirRecetaMedicamentos(){
        try{
            ...
            JasperPrint informe = JasperFillManager.fillReport(System.getProperty("user.dir")+"/Reportes/incapacidad.jasper", parametro, getConnection());
            JRExporter exporter = new JRPdfExporter();
            exporter.setParameter(JRExporterParameter.JASPER_PRINT, informe);
            tempFile = File.createTempFile("Incapacidad",".pdf");

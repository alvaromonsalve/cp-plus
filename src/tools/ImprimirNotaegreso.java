...
public class ImprimirNotaegreso {
     ...
     public PdfReader ImprimirNotaEgreso(){
        try{
            ...
            JasperPrint informe = JasperFillManager.fillReport(System.getProperty("user.dir")+"/Reportes/NotaEgreso.jasper", parametro, getConnection());
            JRExporter exporter = new JRPdfExporter();
            exporter.setParameter(JRExporterParameter.JASPER_PRINT, informe);
            tempFile = File.createTempFile("Nota Egreso",".pdf");

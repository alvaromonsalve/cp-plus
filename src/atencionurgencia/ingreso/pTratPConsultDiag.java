 ...
 */
public class pTratPConsultDiag extends javax.swing.JPanel {
    ...
    /**
     * Creates new form pTratPConsultDiag
     */
    public pTratPConsultDiag() {
        initComponents();
        setCargaTabla();
    }
    ...
    public void saveChanges(EntityManagerFactory factory, InfoHistoriac ihc){
            ...
            if(!exist){
                ...
                if(procedimientoHcu!=null){
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "10077:\n"+ex.getMessage(), pTratPConsultDiag.class.getName(), JOptionPane.INFORMATION_MESSAGE);
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(null, "10078:\n"+ex.getMessage(), pTratPConsultDiag.class.getName(), JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            }
        }
        for(int i=0;i<listInfoProcedimientoHcu.size();i++){
            ...
            if(cups.getIdEstructuraCups().getId() ==16){
                boolean exist=false;
                ...
                if(!exist){
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "10079:\n"+ex.getMessage(), pTratPConsultDiag.class.getName(), JOptionPane.INFORMATION_MESSAGE);
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(null, "10080:\n"+ex.getMessage(), pTratPConsultDiag.class.getName(), JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            }
        }

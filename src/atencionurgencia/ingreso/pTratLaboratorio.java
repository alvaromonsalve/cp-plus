 ...
 */
public class pTratLaboratorio extends javax.swing.JPanel {
    ...
    /**
     * Creates new form pTratLaboratorio
     */
    public pTratLaboratorio() {
        initComponents();
        setCargaTabla();
    }
    ...
    public void cargaDatoSeleccionado(ConfigCups cc,String observ){
     ...
     public void saveChanges(EntityManagerFactory factory, InfoHistoriac ihc){
            ...
            if(!exist){
                ...
                if(procedimientoHcu!=null){
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "10081:\n"+ex.getMessage(), pTratLaboratorio.class.getName(), JOptionPane.INFORMATION_MESSAGE);
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(null, "10082:\n"+ex.getMessage(), pTratLaboratorio.class.getName(), JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            }
        }
        for(int i=0;i<listInfoProcedimientoHcu.size();i++){
            ...
            if(cups.getIdEstructuraCups().getId() ==17){
                boolean exist=false;
                ...
                if(!exist){
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "10083:\n"+ex.getMessage(), pTratLaboratorio.class.getName(), JOptionPane.INFORMATION_MESSAGE);
                    }  catch (Exception ex) {
                        JOptionPane.showMessageDialog(null, "10084:\n"+ex.getMessage(), pTratLaboratorio.class.getName(), JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            }
        }

...
public class pAnexo3 extends javax.swing.JPanel {
    ...
    public InfoHistoriac infoHistoriac;
    
    /**
     * Creates new form pAnexo3
     */
    public pAnexo3() {
        initComponents();
        setCargaTabla();
    ...
    private void setCargaTabla(){
        ...
        Funciones.setSizeColumnas(jTable1, new int[]{0,2,3}, new int[]{30,60,60});
        jTable1.setDefaultRenderer(Object.class, new tools.IconCellRenderer());
        Funciones.setColorTableHeader(jTable1, new int[]{0,2,3,4});
    }
    ...
    private void initComponents() {
        ...
        jLabel49.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/product-sales-report-icon.png"))); // NOI18N
        jLabel49.setText("Anexo 3");
        ...
        buttonSeven7.setText("Actualizar");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jScrollPane27, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel32, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if(SwingUtilities.isLeftMouseButton(evt) && evt.getClickCount()==1){
            if(jTable1.columnAtPoint(evt.getPoint())==2){
                ...
                numericKeypad keypad= new numericKeypad(jTable1,jTable1.getSelectedRow(),pop);
                pop.add(keypad);
                pop.setVisible(true);
...
//            ModeloTabla.setValueAt(box, jTable1.getSelectedRow(), 1);
    ...
    private void jTable1MouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseMoved
        ...
        "<div style=\"width:300;\">"+(String)jTable1.getValueAt(rowIndex, 4)+"</div>\n" +
        "\n" +
        "</html>");
